...
import LogoIcon from '../Images/ethLogoBlue.png'
...
const Menu = ({ setMenuOpen, darkMode, setDarkMode, setUploadOpen }) => {
    ...
    return (
        <MenuContainer setMenuOpen={setMenuOpen}>
            ...
            <Link to='/latest' style={{ textDecoration: "none", color: "inherit", width: '100%' }}>
                <Elements>
                    <AttachMoneyIcon />
                    <NavText>Latest Transaction</NavText>
                </Elements>
            </Link>
            <Link to='/generatehooks' style={{ textDecoration: "none", color: "inherit", width: '100%' }}>
                <Elements>
                    <AttachMoneyIcon />
                    <NavText>Generate WebHooks</NavText>
                </Elements>
            </Link>
            {
                currentUser ?
