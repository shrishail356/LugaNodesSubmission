...
const SignUp = ({ setSignUpOpen, setSignInOpen }) => {
    ...
    const createAccount = () => {
      if (otpVerified) {
        ...
        setLoading(true);
        try {
          signUp({ name, email,phoneNumber, telegramId, password }).then((res) => {
            if (res.status === 200) {
    ...
    }, [name, email, passwordCorrect, phoneNumber,password, nameCorrect]);
          ...
          <Wrapper>
            ...
            {!otpSent ?
              <>
                ...
                <OutlinedBox>
                  <PhoneRounded sx={{ fontSize: "20px" }} style={{ paddingRight: "12px" }} />
                  {/* Phone input with theme-based styling */}
                  <PhoneInput
                    country={"us"}
                    value={phoneNumber}
                    ...
                    inputStyle={{
                      ...
                      fontSize: "14px",
                      color: theme.text_primary, // Use theme colors for text
                    }}
                    buttonStyle={{
                      border: "none",
                      background: "transparent",
                      color: theme.text_primary, // Use theme colors for the button
                    }}
                    containerStyle={{
                      width: "100%",
                    }}
                    dropdownStyle={{
                      background: theme.card, // Use theme background for dropdown
                      color: theme.text_primary, // Use theme colors for dropdown text
                    }}
                  />
                </OutlinedBox>
                <OutlinedBox>
                  <telegramId sx={{ fontSize: "20px" }} style={{ paddingRight: "12px" }} />
                  <TextInput
